...
function DrawingCanvas() {
  ...
  /**********************************Collab logics ***************************************/
  const updateRoomDetails = (userDetails) => {
    if (user._id !== userDetails.userId) {
      ...
      var collabMap = new Map(JSON.parse(localStorage.getItem("collabUsers")));
  ...
  }, [socket, sharedMouseDown, sharedMouseMove, sharedMouseUp, setRoomDetails]);
